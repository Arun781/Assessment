...
using LoginAndRegisterApplication.Data;
using LoginAndRegisterApplication.Models;

namespace LoginAndRegisterApplication.Controllers
{
    public class EmployeeDetailsController : Controller
    {
        private LoginAndRegisterApplicationContext db = new LoginAndRegisterApplicationContext();

        [HttpPost]
        public ActionResult Login(string username, string password)
        {
            // Find the user by name and password
            EmployeeDetails user = db.EmployeeDetails.FirstOrDefault(u => u.Name == username && u.Password == password);
